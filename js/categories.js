    ...
    for(let i = 0; i < currentCategoriesArray.length; i++){
        ...
        if((barraFiltrador == undefined) || (categoryName.includes(barraFiltrador)) || (categoryDescription.includes(barraFiltrador))){
            ...
            if (((minCount == undefined) || (minCount != undefined && parseInt(category.productCount) >= minCount)) &&
                ...
                htmlContentToAppend += `
                <a href="category-info.html" class="list-group-item list-group-item-action mb-3 listcat">
                    <div class="row">
                        <div class="col-3">
                        ...
                        <div class="col">
                            <div class="d-flex w-100 justify-content-between">
                                <h4 class="mb-1 catname">`+ category.name +`</h4>
...
document.addEventListener("DOMContentLoaded", function(e){
    ...
    document.getElementById("sortByArticles").addEventListener("click", function(){
